    ...
    return(
        <>
            ...
            <div className='h-screen flex overflow-x-hidden' id='main'>
                ...
                {/* Section 3 */}
                <div className='flex-col gap-8 flex-[0_0_100vw] justify-center px-24 pt-24 text-white bg-cover hidden' style={clickItem == 4 ? { backgroundImage: `url(${backgroundImage})` } : {}} id='section3'>
